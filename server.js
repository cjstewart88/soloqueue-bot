...
function handle_data (data, command, from) {
  ...
  switch (command) {
    case "counters":
      the_bot.say(from, the_data.data[0][0] + " counters: " + (the_data.data[0][1] != null ? the_data.data[0][1].counters.join(", ") : "n/a") + "[More on: http://www.soloqueue.com/#" + encode(the_data.data[0][0]) + "]");
    ...
    case "champ":
      ...
      if (found_champ)  the_bot.say(from, "Champion Name: " + champ_name + response + "[More on: http://www.soloqueue.com/#" + encode(champ_name) + "]");
    ...
    case "item":
      ...
      if (found_item) the_bot.say(from, "Item Name: " + item_name + response + " [More on: http://www.soloqueue.com/#" + encode(item_name) + "]");
